...
export declare type CommonPieProps<RawDatum> = Dimensions & {
...
export declare type PieSvgProps<RawDatum> = DataProps<RawDatum> & Partial<CommonPieProps<RawDatum>> & SvgDefsAndFill<ComputedDatum<RawDatum>> & PieHandlers<RawDatum, SVGPathElement> & {
    layers?: PieLayer<RawDatum>[];
};
export declare type CompletePieSvgProps<RawDatum> = DataProps<RawDatum> & CommonPieProps<RawDatum> & SvgDefsAndFill<ComputedDatum<RawDatum>> & PieHandlers<RawDatum, SVGPathElement> & {
    layers: PieLayer<RawDatum>[];
};
export declare type PieCanvasProps<RawDatum> = DataProps<RawDatum> & Partial<CommonPieProps<RawDatum>> & Pick<PieHandlers<RawDatum, HTMLCanvasElement>, 'onClick' | 'onMouseMove'> & {
    pixelRatio?: number;
};
export declare type CompletePieCanvasProps<RawDatum> = DataProps<RawDatum> & CommonPieProps<RawDatum> & Pick<PieHandlers<RawDatum, HTMLCanvasElement>, 'onClick' | 'onMouseMove'> & {
    pixelRatio: number;
};
